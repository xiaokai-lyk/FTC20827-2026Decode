...
public class Test1 extends XKCommandOpmode {
    ...
    @Override public void run() {
        ...
        if(step == 2){
            shooter.blockBallPass().schedule();
            AutoDrive.Output out = autoDrive.driveToAdaptive( // Collect Pos 1
                drive,
                adaptiveController,
                -100,
                -50,
        ...
        if(step == 3){
            intake.startIntake(false).schedule();
            AutoDrive.Output out = autoDrive.driveToAdaptive( // Collect the artifacts
                drive,
                adaptiveController,
                -100,
                -50,
        ...
        if(step == 4){
            AutoDrive.Output out= autoDrive.driveToAdaptive( // drive to shooting pos
                drive,
                adaptiveController,
                -100,
                -50,
