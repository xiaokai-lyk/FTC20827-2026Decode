...
public class TopRouteRed extends XKCommandOpmode {
    ...
    private void moveToShootingPos(double expTime) {
        ...
        AutoDrive.Output out = autoDrive.driveToAdaptive(
            drive,
            adaptiveController,
            Constants.redShootingPosTop[0].x,
            Constants.redShootingPosTop[0].y,
            Constants.redShootingPosTop[0].heading,
            odo,
            1,
            true
        );
    ...
    private void moveToIntakePos(int posNum) {
        ...
        AutoDrive.Output out = autoDrive.driveToAdaptive(
            drive,
            adaptiveController,
            Constants.redPickUpPositionTop[posNum].x,
            Constants.redPickUpPositionTop[posNum].y,
            Constants.redPickUpPositionTop[posNum].heading,
            odo,
            1,
            false
        );
    ...
    private void IntakeBalls(int posNum) {
        ...
        AutoDrive.Output out = autoDrive.driveToAdaptive(
            ...
            adaptiveController,
            Constants.redPickUpPositionTop[posNum].x,
            Constants.redPickUpPositionTop[posNum].y - 110,
            Constants.redPickUpPositionTop[posNum].heading,
            odo,
            0.9,
            true
    ...
    private void moveToGate() {
        ...
        AutoDrive.Output out = autoDrive.driveToAdaptive(
            drive,
            adaptiveController,
            Constants.redGatePosition.x,
            Constants.redGatePosition.y + 50,
            Constants.redGatePosition.heading,
            odo,
            0.9,
            false
        );
    ...
    private void moveFromLine() {
        AutoDrive.Output out = autoDrive.driveToAdaptive(
            drive,
            adaptiveController,
            Constants.redParkPositionTop.x,
            Constants.redParkPositionTop.y,
            Constants.redParkPositionTop.heading,
            odo,
            1,
            true
        );
